...
st.set_page_config(page_title="Date export NCM 9 Cifre", layout="wide")
st.markdown("# Date export NCM 9 Cifre")

# === Funcții ===
def incarca_date(cale_fisier: str = "data/Export_Date_9_Cifre.xlsx") -> pd.DataFrame:
    try:
