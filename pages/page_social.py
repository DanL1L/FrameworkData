...
def render():
    ...
    if df.empty:
        st.warning("⚠️ Fisierul Date_Sector_Social.xlsx nu a putut fi citit.")
        return
    ...
    tab1, tab2, tab3 = st.tabs(["Somaj & Ocupare", "Salarii", "Date tabelare"])
    ...
    with tab1:
        ...
        with col1:
            ...
            st.markdown('<div class="chart-source">Sursa: Date_Sector_Social.xlsx — Ancheta fortei de munca (BIM)</div></div>', unsafe_allow_html=True)
        ...
        with col2:
            ...
            st.markdown('<div class="chart-source">Sursa: Date_Sector_Social.xlsx</div></div>', unsafe_allow_html=True)
    ...
    with tab2:
        ...
        with col2:
            ...
            st.markdown('<div class="chart-source">Calcule pe baza Date_Sector_Social.xlsx</div></div>', unsafe_allow_html=True)
    ...
    with tab3:
        ...
        st.markdown('<div class="chart-source">Sursa: Date_Sector_Social.xlsx — BNS Ancheta fortei de munca</div></div>', unsafe_allow_html=True)
